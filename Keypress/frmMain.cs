    ...
    public partial class frmMain : Form
    {
        ...
        private void iniread()
        {
            try
            {
                ...
                txtWindowName.Text = finiset.ReadString("KeyPress", "window", null);
        ...
        private void iniwrite()
        {
            try
            {
                ...
                finiset.WriteString("KeyPress", "window", txtWindowName.Text);
        ...
        private void sFormClose(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void BTNKeyPressStart_Click(object sender, EventArgs e)
        {
            ...
            if (btnKeyPressStart.Text == "Start" && txtHotKey.Focused == false)
            {
                ...
                if (txtWindowName.Text=="")
                {
                    ...
                    int length = GetWindowTextLength(hwndkp);
                    StringBuilder sb = new StringBuilder(length*2 + 1);
                    GetWindowText(hwndkp, sb, sb.Capacity);
                    txtWindowName.Text = sb.ToString();
                }
                hwndkp = FindWindow(null, txtWindowName.Text);
                labLog.Text = hwndkp.ToString();
        ...
        void skp1()
        {
            while (true)
            {
                while (hwndkp != IntPtr.Zero && KeyPressSleep1 != -1 && KeyNum1 > 31 && KeyNum1 < 225)
                {
        ...
        void skp2()
        {
            while (true)
            {
                while (hwndkp != IntPtr.Zero && KeyPressSleep2 != -1 && KeyNum2 > 31 && KeyNum2 < 225)
                {
        ...
        void skp3()
        {
            while (true)
            {
                while (hwndkp != IntPtr.Zero && KeyPressSleep3 != -1 && KeyNum3 > 31 && KeyNum3 < 225)
                {
        ...
        void skp4()
        {
            while (true)
            {
                while (hwndkp != IntPtr.Zero && KeyPressSleep4 != -1 && KeyNum4 > 31 && KeyNum4 < 225)
                {
